...
class OtherEventsPage extends StatefulWidget {
  const OtherEventsPage({super.key});

  @override
  State<OtherEventsPage> createState() => _OtherEventsPageState();
}
...
class _OtherEventsPageState extends State<OtherEventsPage> {
  ...
  Future<List<EventModel>> _fetchEvents() async {
    final response = await http.get(Uri.parse(
        'https://app.ticketmaster.com/discovery/v2/events.json?size=1&apikey=RHwAPQXmD6FYGazlXrFptM2InjWlpN6O&classificationName=miscellaneous'));
